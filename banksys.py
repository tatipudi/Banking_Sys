print("="*30)
customerNames = ['Mouni','Chinnu','Devi','John','Chinni']
customerPins = ['0225','2256','2206','2205','5622']
    ...
    if choiceNumber == "1" :
        ...
        while j < 1 :
            ...
            while k < len(customerNames) - 1 :
                k = k + 1
                # These two if conditions find where bith the name and pin matches.
                if name == customerNames[k]:
                    if pin == customerPins[k]:
                        ...
                        # The if condition below would look whether the window is greater than the balance.
                        if withdrawal > balance :
                            # this statement below would take a deposition from the customer.
                            deposition = eval(input("Please deposit a hogher value because your balance mentioned above is not enough :"))
                            # These few statements would update the value add show the balance to user.
                            balance = balance + deposition
                            print("Your Current Balance : " , end = " ")
                            print( balance, end = " ")
                            print(" -/Rs\n ") # 1000-500 = 500
        ...
        n = 0
        # The while loop below would work then the pin or the username is wrong.
        while n < 1 :
            k = -1
            name = input("Please input name : ")
            pin = input("Please input pin : ")
            ...
            while k < len(customerNames) - 1 :
                ...
                if name == customerNames[k] :
                    if pin == customerPins[k] :
                        n = n + 1
                        # These statements below would show the customer balance and update list values according to the depostion made.
                        print(" Your Current Balance : ", end = " ")
                        print(customerBalances[k], end = " ")
                        print("-/Rs")
                        balance = (customerBalances[k])
            ...
            if n < 1 :
                print(" Your name and pin does not match! \n")
                break
            #This statement below helps the helps the user to go back to the start of the program (main menu).
